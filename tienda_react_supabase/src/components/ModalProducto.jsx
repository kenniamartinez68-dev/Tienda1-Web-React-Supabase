...
export default function ModalProducto() {
  const { productoSeleccionado,handleClickModal,handleAgregarPedido,pedido } = useContext(AdminProductoContext);
    ...
    <div className="md:flex items-center gap-10">
      ...
      <div className="md:w-2/3">
        ...
        <p className="mt-5 font-black text-5xl text-amber-500">
          {formatearDinero(productoSeleccionado.precio)}
        </p>
        ...
        <button
          ...
          onClick={() => {
            handleAgregarPedido({...productoSeleccionado, cantidad})
            handleClickModal()
          }}
        >
